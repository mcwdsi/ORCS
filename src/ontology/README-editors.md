These notes are for the EDITORS of orcs
...
Make sure you have an ID range in the [idranges file](orcs-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [orcs-edit.owl](orcs-edit.owl)

** DO NOT EDIT orcs.obo OR orcs.owl in the top level directory **

[../../orcs.owl](../../orcs.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/dillerm/ORCS) for details.
 ...
 * [orcs-idranges.owl](orcs-idranges.owl)
...
This generates derived files such as orcs.owl and orcs.obo and places
 ...
 * https://github.com/dillerm/ORCS/releases
 * https://github.com/dillerm/ORCS/releases/new
...
what is in the `owl:versionIRI` of the derived orcs.owl (`data-version` in
orcs.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/orcs.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/orcs/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/dillerm/ORCS.svg?branch=master)](https://travis-ci.org/dillerm/ORCS)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/dillerm](https://travis-ci.org/profile/dillerm)
 2. click the "Sync account" button
 3. Click the tick symbol next to ORCS
