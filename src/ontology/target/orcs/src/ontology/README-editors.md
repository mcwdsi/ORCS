...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/dillerm/False) for details.
 ...
 * https://github.com/dillerm/False/releases
 * https://github.com/dillerm/False/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/dillerm/False.svg?branch=master)](https://travis-ci.org/dillerm/False)
