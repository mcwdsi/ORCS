 ...
 * [orcs.yml](orcs.yml)
     * Determines how your purl.obolibrary.org/obo/orcs/ redirects will be handled
     ...
     * Paste in the contents of [orcs.yml](orcs.yml)
 ...
 * [orcs.md](orcs.md)
     ...
     * Paste in the contents of [orcs.md](orcs.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
